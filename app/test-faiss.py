...
def get_image_urls_from_db(image_ids):
...
def print_image_urls(similar_image_ids, image_urls):
    for image_id in similar_image_ids:
        ...
        image_id_str = 'PF' + str(image_id)
        if image_id_str in image_urls:
            print(f"Image ID: {image_id_str}, URL: {image_urls[image_id_str]}")
        else:
            print(f"Image ID: {image_id_str}의 URL을 찾을 수 없습니다.")
...
if __name__ == "__main__":
    ...
    image_urls = get_image_urls_from_db(similar_image_ids)
